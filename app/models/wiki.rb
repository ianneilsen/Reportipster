class Wiki
  ...
  def edit_web(old_address, new_address, name, markup, color, additional_style, safe_mode = false,
    ...
    allow_uploads = true, max_upload_size = nil, emailadm, emailto, emailcc)
    ...
    :brackets_only => brackets_only, :count_pages => count_pages, :allow_uploads => allow_uploads, :max_upload_size => max_upload_size, :emailadm => emailadm, :emailto => emailto, :emailcc => emailcc)
    @webs = nil
