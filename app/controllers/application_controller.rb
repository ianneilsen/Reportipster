...
class ApplicationController < ActionController::Base
  ...
  def connect_to_model
    ...
    @web_name = params['web']
    @wiki = wiki
    @author = cookies['author'] || 'RAPBrisbane'
    if @web_name
  ...
  def authorization_needed?
    not %w(login authenticate feeds published publist atom_with_headlines atom_with_content file blahtex_png).include?(action_name)
  end
